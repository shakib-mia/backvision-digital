  ...
  return (
    <div className="flex flex-col gap-2 mt-7 mx-4 text-justify">
      <p>
        ...
        BackVision Digital, a Digital Distribution firm (“BackVision Digital”,
        “First Part” or “us”) regarding your use of our BackVision Digital
        service to distribute your musical recordings to selected digital
        services and stores (“Schedule”), you are entering into this Agreement
        on behalf of one or more other people, a group, or a company or other
        entity, then by accepting this Agreement you represent and warrant to us
        that you are duly authorized to do so on behalf of all such
        person(s)/entity(ies) and to bind them to this Agreement and that First
        Part is fully entitled to rely on that fact (in which case, the term
        “Second Part ” includes all such people and entities) in our performance
