  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={`fixed inset-0 bg-black z-10 transition-opacity ${
          notificationDropdownOpen
      ...
      <div
        ...
        } transition-[right] top-0 w-[500px] h-screen bg-gray-800 text-white shadow-lg rounded-lg overflow-y-auto overflow-x-hidden z-20`}
      >
