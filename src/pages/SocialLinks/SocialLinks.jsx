...
const SocialLinks = () => {
  ...
  const platformIcons = {
    spotify: <FaSpotify className="text-xl lg:text-2xl" />,
    apple: <FaApple className="text-xl lg:text-2xl" />,
    youtube: <FaYoutube className="text-xl lg:text-2xl" />,
    default: <FaMusic className="text-xl lg:text-2xl" />, // fallback icon
  ...
  return (
    <div className="py-7 pb-[256px] lg:pb-7 flex justify-center mt-4">
      <div className="shadow-xl shadow-[#000] p-3 text-grey-dark w-11/12 lg:w-1/2">
        <FaChevronLeft
            ...
            (item, key) =>
              ...
              item === "Meta" || (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-2 my-2 shadow-md lg:shadow-lg p-2 rounded hover:shadow transition text-white"
                >
