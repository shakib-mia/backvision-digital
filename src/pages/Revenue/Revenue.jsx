...
const Revenue = () => {
  ...
  const getExcel = () => {
    ...
    a.href = url;
    a.download = `BackVision Digital - Revenue Report of ${userData.first_name} ${userData.last_name}.xlsx`;
  ...
  const createPdf = async () => {
    ...
    const pdf = await generatePDF(targetRef, {
      filename: `BackVision Digital - Revenue Report of ${userData.first_name} ${userData.last_name}.pdf`,
      page: {
        // default is 'A4'
        format: "A4",
        // scale: 2,
