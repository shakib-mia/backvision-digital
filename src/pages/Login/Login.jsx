    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 max-w-4xl mx-auto rounded-lg overflow-hidden shadow-[0_10px_12px] shadow-[#000]">
        ...
        <div className="p-4">
          ...
          <form onSubmit={handleLogin} className="mt-1 lg:mt-3">
            <InputField
              type="email"
              label="Email"
          ...
          <button className="flex w-full py-2 border border-interactive-light rounded-full justify-center items-center group transition hover:bg-interactive-light">
            <svg
